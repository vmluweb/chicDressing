...
$featured_links_image_1 = wp_get_attachment_image_src(ashe_options('featured_links_image_1'), 'medium');
$featured_links_image_2 = wp_get_attachment_image_src(ashe_options('featured_links_image_2'), 'medium');
$featured_links_image_3 = wp_get_attachment_image_src(ashe_options('featured_links_image_3'), 'medium');
